...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        ...
        authorizationRegistry
                ...
                .requestMatchers(HttpMethod.POST, "/auth/login/refresh").permitAll()
                .requestMatchers(HttpMethod.POST, "/login/logout").permitAll()
                .requestMatchers(HttpMethod.POST, "/auth/login/logout").permitAll()
    ...
    public RoleHierarchy roleHierarchy() {
        return RoleHierarchyImpl.withDefaultRolePrefix()
                .role("ADMIN").implies("GERENTE_LOGISTICA")
                .role("GERENTE_LOGISTICA").implies("OPERADOR_LOGISTICA")
                .role("OPERADOR_LOGISTICA").implies("CONSULTA")
                .role("MECANICO").implies("CONSULTA")
                .role("MOTORISTA").implies("CONSULTA")
                .build();
    }
